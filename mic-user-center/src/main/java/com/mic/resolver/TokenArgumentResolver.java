package com.mic.resolver;

import cn.hutool.core.util.StrUtil;
import com.mic.constant.annotation.LoginUser;
import com.mic.constant.constant.SecurityConstants;
import com.mic.constant.model.SysRole;
import com.mic.constant.model.SysUser;
...
public class TokenArgumentResolver implements HandlerMethodArgumentResolver {
    ...
    public Object resolveArgument(MethodParameter methodParameter,
        ...
        if (isFull) {
            SysUserVo sysUserVo = userService.selectByUsername(username);
