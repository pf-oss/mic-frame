package com.mic.elasticsearch.utils;
...
public class SearchBuilder {
     ...
     * @param indexName
     */
    public static SearchBuilder builder(String indexName) {
        SearchSourceBuilder searchSourceBuilder = new SearchSourceBuilder();
        SearchRequest searchRequest = new SearchRequest(indexName);
        searchRequest.source(searchSourceBuilder);
        return new SearchBuilder(searchRequest, searchSourceBuilder);
    }
    ...
    private List<JsonNode> getList(SearchHits searchHits) {
        ...
        if (searchHits != null) {
            searchHits.forEach(item -> {
                JsonNode jsonNode = parse(item.getSourceAsString());
