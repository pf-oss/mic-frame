...
import com.mic.base.model.SysUser;
import com.mic.security.converter.CustomUserAuthenticationConverter;
 ...
 */
@ConditionalOnProperty(prefix = "mic.oauth2.token.store", name = "type", havingValue = "authJwt")
